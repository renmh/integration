 ...
 */
package com.pansky.integration.generate;
...
//		Boolean isEnable = false;
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/pansky/integration/generate/template", "/", separator);
		...
		String javaTestPath = StringUtils.replaceEach(projectPath+"/src/test/java/"+StringUtils.lowerCase(packageName), 
				new String[]{"/", "."}, new String[]{separator, separator});
