...
<body>
		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="brand" href="${ctx}"><img
					src="${ctxStatic}/images/logo.png" alt="Pansky Admin"
					style="height:40px;">
				</a>
			</div>
		</div>
	...
	<div class="container">
		...
		<div id="messageBox"
			...
			<label id="loginError" class="error"><%=error==null?"":"com.pansky.integration.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
		</div>
		<div id="login-wraper">
			<form id="loginForm" class="form login-form" action="${ctx}/login"
				...
				<div class="footer">
					<label class="checkbox inline"> <input type="checkbox"
						id="rememberMe" name="rememberMe"> <span
						style="color:#08c;">记住我</span> </label> <input class="btn btn-primary"
	...
	<footer class="white navbar-fixed-bottom">
		...
		- Powered By <a href="https://www.pansky.com"
			target="_blank">长天科技集团</a> ${fns:getConfig('version')}
	</footer>
</body>
</html>