...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctxFront}/user/info">个人信息</a></li>
		<li><a href="${ctxFront}/user/modifyPwd">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctxFront}/user/info" method="post" class="form-horizontal">
